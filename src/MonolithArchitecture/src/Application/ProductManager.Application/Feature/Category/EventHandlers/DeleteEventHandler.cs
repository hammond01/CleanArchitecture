...
public class CategoryDeleteEventHandler : IDomainEventHandler<EntityDeletedEvent<Categories>>
{
    ...
    public CategoryDeleteEventHandler(ICrudService<AuditLog> auditService, ICurrentUser currentUser,
    ...
    public async Task HandleAsync(EntityDeletedEvent<Categories> domainEvent, CancellationToken cancellationToken = default)
    {
        var auditLog = new AuditLog
        {
            ...
            Action = EventTypeConstants.CategoryDeleted,
        ...
        {
            Id = UlidExtension.Generate(),
            EventType = EventTypeConstants.CategoryDeleted,
