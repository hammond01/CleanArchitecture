...
namespace ProductManager.Application.Feature.Employee.EventHandlers;

public class EmployeeUpdatedEventHandler : IDomainEventHandler<EntityUpdatedEvent<Employees>>
{
    ...
    public EmployeeUpdatedEventHandler(ICrudService<AuditLog> auditService, ICurrentUser currentUser,
    ...
    public async Task HandleAsync(EntityUpdatedEvent<Employees> domainEvent, CancellationToken cancellationToken = default)
    {
        var auditLog = new AuditLog
        {
            ...
            Action = EventTypeConstants.EmployeeUpdated,
        ...
        {
            Id = UlidExtension.Generate(),
            EventType = EventTypeConstants.EmployeeUpdated,
