...
public class EmployeeDeleteEventHandler : IDomainEventHandler<EntityDeletedEvent<Employees>>
{
    ...
    public EmployeeDeleteEventHandler(ICrudService<AuditLog> auditService, ICurrentUser currentUser,
    ...
    public async Task HandleAsync(EntityDeletedEvent<Employees> domainEvent, CancellationToken cancellationToken = default)
    {
        var auditLog = new AuditLog
        {
            ...
            Action = EventTypeConstants.EmployeeDeleted,
        ...
        {
            Id = UlidExtension.Generate(),
            EventType = EventTypeConstants.EmployeeDeleted,
