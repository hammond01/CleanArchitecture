...
public class EmployeeCreatedEventHandler : IDomainEventHandler<EntityCreatedEvent<Employees>>
{
    ...
    public EmployeeCreatedEventHandler(ICrudService<AuditLog> auditService, ICurrentUser currentUser,
    ...
    public async Task HandleAsync(EntityCreatedEvent<Employees> domainEvent, CancellationToken cancellationToken = default)
    {
        var auditLog = new AuditLog
        {
            ...
            Action = EventTypeConstants.EmployeeCreated,
        ...
        {
            Id = UlidExtension.Generate(),
            EventType = EventTypeConstants.EmployeeCreated,
