...
public class SupplierUpdatedEventHandler : IDomainEventHandler<EntityUpdatedEvent<Suppliers>>
{
    ...
    public SupplierUpdatedEventHandler(ICrudService<AuditLog> auditService, ICurrentUser currentUser,
    ...
    public async Task HandleAsync(EntityUpdatedEvent<Suppliers> domainEvent, CancellationToken cancellationToken = default)
    {
        var auditLog = new AuditLog
        {
            ...
            Action = EventTypeConstants.SupplierUpdated,
        ...
        {
            Id = UlidExtension.Generate(),
            EventType = EventTypeConstants.SupplierUpdated,
