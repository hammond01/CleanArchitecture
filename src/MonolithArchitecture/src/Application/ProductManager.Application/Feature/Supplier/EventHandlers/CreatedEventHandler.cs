...
public class SupplierCreatedEventHandler : IDomainEventHandler<EntityCreatedEvent<Suppliers>>
{
    ...
    public SupplierCreatedEventHandler(ICrudService<AuditLog> auditService, ICurrentUser currentUser,
    ...
    public async Task HandleAsync(EntityCreatedEvent<Suppliers> domainEvent, CancellationToken cancellationToken = default)
    {
        var auditLog = new AuditLog
        {
            ...
            Action = EventTypeConstants.SupplierCreated,
        ...
        {
            Id = UlidExtension.Generate(),
            EventType = EventTypeConstants.SupplierCreated,
