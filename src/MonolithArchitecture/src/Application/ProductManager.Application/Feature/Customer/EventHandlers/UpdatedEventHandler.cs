...
namespace ProductManager.Application.Feature.Customer.EventHandlers;

public class CustomerUpdatedEventHandler : IDomainEventHandler<EntityUpdatedEvent<Customers>>
{
    ...
    public CustomerUpdatedEventHandler(ICrudService<AuditLog> auditService, ICurrentUser currentUser,
    ...
    public async Task HandleAsync(EntityUpdatedEvent<Customers> domainEvent, CancellationToken cancellationToken = default)
    {
        var auditLog = new AuditLog
        {
            ...
            Action = EventTypeConstants.CustomerUpdated,
        ...
        {
            Id = UlidExtension.Generate(),
            EventType = EventTypeConstants.CustomerUpdated,
