...
public class CustomerDeleteEventHandler : IDomainEventHandler<EntityDeletedEvent<Customers>>
{
    ...
    public CustomerDeleteEventHandler(ICrudService<AuditLog> auditService, ICurrentUser currentUser,
    ...
    public async Task HandleAsync(EntityDeletedEvent<Customers> domainEvent, CancellationToken cancellationToken = default)
    {
        var auditLog = new AuditLog
        {
            ...
            Action = EventTypeConstants.CustomerDeleted,
        ...
        {
            Id = UlidExtension.Generate(),
            EventType = EventTypeConstants.CustomerDeleted,
