...
public class CustomerCreatedEventHandler : IDomainEventHandler<EntityCreatedEvent<Customers>>
{
    ...
    public CustomerCreatedEventHandler(ICrudService<AuditLog> auditService, ICurrentUser currentUser,
    ...
    public async Task HandleAsync(EntityCreatedEvent<Customers> domainEvent, CancellationToken cancellationToken = default)
    {
        var auditLog = new AuditLog
        {
            ...
            Action = EventTypeConstants.CustomerCreated,
        ...
        {
            Id = UlidExtension.Generate(),
            EventType = EventTypeConstants.CustomerCreated,
