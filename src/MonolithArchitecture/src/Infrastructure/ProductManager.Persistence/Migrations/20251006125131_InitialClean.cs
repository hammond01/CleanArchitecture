        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TriggeredById = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "01JH179GGG9BN2V8SS9RG70QNG", "Mobile Phones", new DateTimeOffset(new DateTime(2025, 10, 6, 19, 51, 31, 459, DateTimeKind.Unspecified).AddTicks(698), new TimeSpan(0, 7, 0, 0, 0)), "Category for the latest mobile phones", null, null, null },
                    { "01JH179GGG9BN2V8SS9RG70QPX", "Accessories", new DateTimeOffset(new DateTime(2025, 10, 6, 19, 51, 31, 459, DateTimeKind.Unspecified).AddTicks(736), new TimeSpan(0, 7, 0, 0, 0)), "Category for accessories such as cases, chargers, cables", null, null, null },
                    { "01JH179GGG9BN2V8SS9RG70QRS", "SIM Cards", new DateTimeOffset(new DateTime(2025, 10, 6, 19, 51, 31, 459, DateTimeKind.Unspecified).AddTicks(738), new TimeSpan(0, 7, 0, 0, 0)), "Category for SIM cards and promotional plans", null, null, null },
                    { "01JH179GGG9BN2V8SS9RG70QTU", "Repair Services", new DateTimeOffset(new DateTime(2025, 10, 6, 19, 51, 31, 459, DateTimeKind.Unspecified).AddTicks(739), new TimeSpan(0, 7, 0, 0, 0)), "Category for professional phone repair services", null, null, null },
                    { "01JH179GGG9BN2V8SS9RG70QVW", "Extended Warranty", new DateTimeOffset(new DateTime(2025, 10, 6, 19, 51, 31, 459, DateTimeKind.Unspecified).AddTicks(741), new TimeSpan(0, 7, 0, 0, 0)), "Category for extended warranty packages", null, null, null }
                });
